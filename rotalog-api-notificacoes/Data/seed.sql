...
('ALERTA_MANUTENCAO', 'email', 'ALERTA: Manutenção necessária - Veículo {{placa}}', 'ATENÇÃO: O veículo {{placa}} precisa de manutenção preventiva.\n\nTipo: {{tipo_manutencao}}\nPrazo: {{prazo}}\n\nVerifique o sistema RotaLog imediatamente.\n\nEquipe RotaLog', true),
